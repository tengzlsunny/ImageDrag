...
var dragStore = (_dragStore = {
  ...
  var srcTop = (document.documentElement.scrollTop || document.body.scrollTop) + 'px',
      srcLeft = (document.documentElement.scrollLeft || document.body.scrollLeft) + 'px';

  var style = this.draggedNode && this.draggedNode.style;
  if (!style) return;
  style.transition = 'all ' + time / 1000 + 's cubic-bezier(0.2,0.4,0.25,1.1)';
  style.transform = 'translate('+srcLeft+','+srcTop+')';
  ...
  _createClass(Drag, [{
    ...
    value: function onMarkMouseMove(e) {
      ...
      var srcTop = document.documentElement.scrollTop || document.body.scrollTop,
          srcLeft = document.documentElement.scrollLeft || document.body.scrollLeft;

      var translateX = pageX - this.mouseDownPosition.left + srcLeft ;
      var translateY = pageY - this.mouseDownPosition.top + srcTop;
